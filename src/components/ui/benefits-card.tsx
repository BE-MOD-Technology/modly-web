...
export const BenefitsCard = ({
  ...
  const icons = [
    // Efficiency icon
    <svg key="efficiency" className="size-6 text-[#7588A1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Target icon
    <svg key="target" className="size-6 text-[#7588A1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
    </svg>,
    // Globe icon
    <svg key="globe" className="size-6 text-[#7588A1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0 9c-5 0-9-4-9-9s4-9 9-9" />
    </svg>,
    // Automation icon
    <svg key="automation" className="size-6 text-[#7588A1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
    </svg>,
    // Focus icon
    <svg key="focus" className="size-6 text-[#7588A1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
